...
<a href="http://localhost/BDMS/i/index.html" target="_blank">VERIFY OTP</a>
 <a href="http://localhost/BDMS/i/admin.php" target="_blank">ADMIN</a>
...
<?php if(isset($_POST['search'])){
  ...
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ?>
    <form action="send_notify.php" method="post">
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            ...
            <input type="hidden" name="number" value="<?php echo $row['donor_number']; ?>">
            <input type="hidden" name="add" value="<?php echo $_POST['address']; ?>">
            <button class="send_btn">Send notify</button>
          </form>   
          </div>
        </div>
  </div>
